  ...
  // 1
    ...
    func addProjectile(_ unit:SKSpriteNode){
      ...
      if player_units.count <= 0{
        ...
        let actionMove = SKAction.move(to: direction, duration: 2.0)
    ...
    func projectileDidCollideWithMonster(_ projectile: SKSpriteNode, _ unit: Unit) {
      //print("Hit")
  ...
  func didBegin(_ contact: SKPhysicsContact) {
    ...
    if ((firstBody.categoryBitMask & PhysicsCategory.projectile != 0) &&
      ...
      if let projectile = firstBody.node as? SKSpriteNode,
        ...
        projectileDidCollideWithMonster(projectile, unit)
      }
    }
  }
}
